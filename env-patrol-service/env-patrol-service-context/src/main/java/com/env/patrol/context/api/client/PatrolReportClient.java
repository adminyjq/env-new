package com.env.patrol.context.api.client;

import com.env.common.constraint.annotations.ClientController;
import com.env.patrol.client.IPatrolReportClient;
 ...
 */
@ClientController
public class PatrolReportClient implements IPatrolReportClient{
